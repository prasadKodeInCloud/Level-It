...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                              //
// packages/spin/lib/template.spinner.js                                                                        //
//                                                                                                              //
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                //
                                                                                                                // 1
Template.__define__("spinner", (function() {                                                                    // 2
  var self = this;                                                                                              // 3
  var template = this;                                                                                          // 4
  return HTML.Raw('<div id="spinner"></div>');                                                                  // 5
}));                                                                                                            // 6
                                                                                                                // 7
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
Template.spinner.rendered = function(){                                                                         // 1
  var target = document.getElementById('spinner');                                                              // 2
  var spinner = new Spinner(Meteor.Spinner.options).spin(target);                                               // 3
};                                                                                                              // 4
                                                                                                                // 5
Meteor.Spinner = {                                                                                              // 6
    options: {                                                                                                  // 7
        lines: 13, // The number of lines to draw                                                               // 8
        length: 8, // The length of each line                                                                   // 9
        width: 3, // The line thickness                                                                         // 10
        radius: 12, // The radius of the inner circle                                                           // 11
        corners: 1, // Corner roundness (0..1)                                                                  // 12
        rotate: 0, // The rotation offset                                                                       // 13
        direction: 1, // 1: clockwise, -1: counterclockwise                                                     // 14
        color: '#000', // #rgb or #rrggbb                                                                       // 15
        speed: 1.2, // Rounds per second                                                                        // 16
        trail: 60, // Afterglow percentage                                                                      // 17
        shadow: false, // Whether to render a shadow                                                            // 18
        hwaccel: false, // Whether to use hardware acceleration                                                 // 19
        className: 'spinner', // The CSS class to assign to the spinner                                         // 20
        zIndex: 2e9, // The z-index (defaults to 2000000000)                                                    // 21
        top: 'auto', // Top position relative to parent in px                                                   // 22
        left: 'auto' // Left position relative to parent in px                                                  // 23
    }                                                                                                           // 24
};                                                                                                              // 25
                                                                                                                // 26
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
//# sourceMappingURL=14e65a9c85032787653c2f66a91d43ef47cb9a31.map
